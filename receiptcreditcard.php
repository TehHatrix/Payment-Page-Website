		            ...
		            <div class="wizard-container" style = "width: 1200px; height: auto	;">
		                ...
		                <form action="" method="">	
		                    	<div class="wizard-header text-center">
		                        	<h3 class="wizard-title">Your Credit card receipt mate!</h3>
														...
														<main>
															<div class="row contacts">
																<div class="col invoice-to">
																	...
																	<div class="email"><a href="mailto:<?php echo $_SESSION['Email']; ?>"><?php echo $_SESSION['Email']; ?></a></div>
																</div>
																<div class="col invoice-details">
																	<h1 class="invoice-id">RECEIPT <?php echo $_SESSION['InvoiceID']; ?></h1>
																	<div class="date">Date of Receipt: <?php echo date("d/m/Y"); ?></div>
																	<div class="date">Card Type : <?php 
																	echo $_SESSION['CardType'];
																	if ($_SESSION['CardType'] == "MasterCard"){
																		echo "<img src = 'assets/img/mastercard.jpg' width = '40' height = '25'>"; 
																	}
																	else {
																		echo "<img src = 'assets/img/visa.jpg' width = '40' height = '25'>"; 
																	}
															...
															<div class="notices">
																<div>NOTICE:</div>
																<div class="notice">Please come to the place with the receipt</div>
															</div>
														</main>
														<footer>
